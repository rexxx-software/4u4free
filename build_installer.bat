...
echo [1/3] Building the application bundle...
...
echo [2/3] Preparing Windows icon...
%PYTHON_EXE% tools\make_windows_icon.py four_u_four_free\assets\brand-mark.png four_u_four_free\assets\4u4free.ico
if errorlevel 1 exit /b %errorlevel%
