...
def sync_manifest_to_config_depotcache(steam_path, manifest_path):
    ...
    try:
        ...
        # The manifest is already in the staging dir under <app_data>/manifests/
...
def remove_acf_and_manifests(
    steam_path, app_id: str | int, mounted_depots: dict, acf_path=None
):
    deleted = 0
