...
@overload
def read_lua_from_zip(path: Union[Path, BytesIO], decode: Literal[True]): ...


@overload
def read_lua_from_zip(path: Union[Path, BytesIO], decode: Literal[False]): ...
...
def read_lua_from_zip(
    ...
    def _handle_member(name, data):
        ...
        if lower.endswith(".lua"):
            ...
            from four_u_four_free._compat.core.utils import manifests_staging_dir
