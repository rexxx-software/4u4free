...
datas = [
    ...
    bundled("store_metadata", "store_metadata"),
    bundled("all_games.txt", "."),
    bundled("sff/lua/fallback_depotkeys.json", "sff/lua"),
    bundled("sff/dlc_unlockers/resources", "sff/dlc_unlockers/resources"),
...
hiddenimports = (
    collect_submodules("sff.dlc_unlockers")
    + collect_submodules("steam")
    + [
        "eventemitter",
        "gevent",
        "gevent.monkey",
...
exe = EXE(
    ...
    icon=str(ROOT / "four_u_four_free" / "assets" / "brand-mark.png"),
