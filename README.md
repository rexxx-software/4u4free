...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-0.5.2-6c63ff">
...
- `dist\4u4free\` - portable application directory
- `dist\4u4free-<version>-Setup.exe` - Windows installer

Tagged releases are built automatically by GitHub Actions. See [docs/RELEASING.md](docs/RELEASING.md) for the complete release checklist.

## Project layout

```text
four_u_four_free/   Main Python package and desktop interface
sff/                Integrated SteaMidra compatibility modules
tools/              Build helpers and the playtime helper source
tests/              Automated test suite
docs/               Command reference and technical guides
...
4u4free is developed and maintained by **rexxx**. It also incorporates and interoperates with open-source projects, including SteaMidra/SFF, whose contributors retain copyright in their work. Project-specific credits and component licenses are documented in [ATTRIBUTION.md](ATTRIBUTION.md) and `third_party_licenses/`.
