...
def toggle_online_fix(steam_path: Path, app_id: str) -> Tuple[bool, str]:
    ...
    if verified != new_state:
        return False, "The launch option write could not be verified. Restore the backup and try again."

    state = "enabled" if new_state else "disabled"
    return True, f"LC Online Fix {state} and verified for App {app_id}. Start Steam to apply."
